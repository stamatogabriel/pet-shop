      ...
      <Container>
        <Wrapper>
          <p>
            ...
            experiência no nosso site. Você pode entender melhor sobre a
            utilização de cookies pelo Direção Concursos e como desativá-los em
            <Link to="/privacidade">saiba mais</Link>.
          </p>
          <button onClick={() => setOpenModal(true)}>Eu concordo</button>
        </Wrapper>
        {openModal && (
          <CookiebarModal openModal={() => setOpenModal(!openModal)} />
        )}
      </Container>
    );
